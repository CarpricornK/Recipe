...
<nav class="navbar navbar-expand-sm navbar-dark d-flex justify-content-between mb-4">
	<a class="navbar-brand linkc" href="/" style="margin-bottom: 0px;">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu">
						<a style="color: blue; " class="dropdown-item linkc" href="/board/saveForm">Board</a>
						<a style="color: blue; " class="dropdown-item linkc" href="/board/RsaveForm">Recipe</a>
						<c:if test="${principal.user.USER_ROLE eq 'ADMIN'}">
							<a style="color: blue; " class="dropdown-item linkc" href="/board/AsaveForm">Notice</a>
						</c:if>
